                ...
                <div className='p-6 lg:px-0 max-w-7xl mx-auto w-full h-full flex flex-col justify-between'>
                    <div className='font-poppins text-white space-y-4 w-full'>
                        <div className='-space-y-1 lg:space-y-1 '>
                            <p className='text-2xl font-andreas lg:text-5xl font-bold'>Extends Tyre Life</p>
                            <p className='text-2xl font-andreas lg:text-5xl font-bold'>By Up To <f className='text-[#FFD101]'>30%</f></p>
                        </div>

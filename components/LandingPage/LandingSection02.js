                ...
                <div className='w-full'>
                    <div className='flex'>
                        ...
                        <div className='font-andreas font-bold text-2xl lg:text-5xl lg:space-y-1'>
                            <p className='px-2'>WHAT IS MAGICSEAL</p>
                    ...
                    <div className='lg:w-10/12 py-12 space-y-8 text-justify font-oswald text-lg lg:text-2xl'>
                        <p>
                            Our range of products are non toxic and environmentally friendly tyre sealants that are introduced into the tyre via the valve. MagicSeal sits harmlessly inside the tyre for the tyre’s natural lifetime as an active and permanent puncture preventative.
                        </p>
